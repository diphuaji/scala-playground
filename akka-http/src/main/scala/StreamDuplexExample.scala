...
// object StreamDuplexExample extends App {
//   Server.run
// }
...
//       Flow[Message].map {
//         case TextMessage.Strict(text) => TextMessage(s"Server received: $text")
...
//     val byteStringStream = Source.tick(1.second, 1.second, "abcdefg")
//     val msg = TextMessage.Streamed(byteStringStream)
